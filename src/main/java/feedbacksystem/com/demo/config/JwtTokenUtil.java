...
public class JwtTokenUtil {
    ...
    public String generateToken(CustomUser customUser) {
        ...
        return doGenerateToken(claims, customUser.getUsername(), customUser.getUserId(), customUser.getAccessType(), customUser.getCompanyId());
    }
    ...
    private String doGenerateToken(Map<String, Object> claims, String subject, Long userId, Integer accessType, Long companyId) {
